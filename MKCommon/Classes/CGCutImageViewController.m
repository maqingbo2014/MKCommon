...
#import "CGCutImageViewController.h"

@interface CGCutImageViewController ()<UIScrollViewDelegate>
{
...
@implementation CGCutImageViewController
...
- (CGCutImageMaskView *)maskView {
    if (MaskView == nil) {
        MaskView = [[CGCutImageMaskView alloc] init];
...
@implementation CGCutImageMaskView

...
+ (NSString *)getCurrentDateYMD {
    return [[NSDate date] toYMDString];
}

+ (NSString *)getCurrentDateYMDHM {
    return [[NSDate date] toYMDHMString];
}

+ (NSString *)getCurrentDateYMDHMS {
    return [[NSDate date] toYMDHMSString];
}

+ (NSString *)getCurrentDateLong {
    return [[NSDate date] toLongint];
}

+ (NSDate *)getDateFromLongLong:(NSString *)longint {
    return [self dateWithTimeIntervalSince1970:[longint longLongValue]];
}
...
+ (NSString *)getDateYMDHMStringFromLongLong:(NSString *)longint {
    return [[self getDateFromLongLong:longint] toYMDHMString];
}

+ (NSString *)getDateYMDStringFromLongLong:(NSString *)longint {
    return [[self getDateFromLongLong:longint] toYMDString];
}

+ (NSString *)getDateHMStringFromLongLong:(NSString *)longint {
    return [[self getDateFromLongLong:longint] toHMString];
}
...
- (NSString *)toLongint {
    NSTimeInterval timeValue = [self timeIntervalSince1970];
    long long int longint=(long long int)timeValue;
    return [NSString stringWithFormat:@"%@",[NSNumber numberWithLongLong:longint]];
}

- (NSString *)toYMString {
    return [[NSDateFormatter formatterYM] stringFromDate:self];
}

- (NSString *)toYMDString {
    return [[NSDateFormatter formatterYMD] stringFromDate:self];;
}

- (NSString *)toHMString {
    return [[NSDateFormatter formatterHM] stringFromDate:self];;
}

- (NSString *)toYMDHMString {
    return [[NSDateFormatter formatterYMDHM] stringFromDate:self];
}

- (NSString *)toYMDHMSString {
    return [[NSDateFormatter formatterYMDHMS] stringFromDate:self];
}


+ (NSString *)judgeDatacycle:(NSString *)timeString days:(NSInteger)days {
    NSDate *timedate=self;
    //用于展示时间 只显示分
